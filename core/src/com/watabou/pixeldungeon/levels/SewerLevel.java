...
public class SewerLevel extends RegularLevel {
    ...
    public String tileName(int tile) {
        return switch (tile) {
            case Terrain.WATER -> "Murky water";
    ...
    public String tileDesc(int tile) {
        return switch (tile) {
            case Terrain.EMPTY_DECO -> "Wet yellowish moss covers the floor.";
            case Terrain.BOOKSHELF -> "The bookshelf is packed with cheap useless books. Might it burn?";
