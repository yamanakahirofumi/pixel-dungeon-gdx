...
public class PrisonLevel extends RegularLevel {
    ...
    public String tileName(int tile) {
        return switch (tile) {
            case Terrain.WATER -> "Dark cold water.";
    ...
    public String tileDesc(int tile) {
        return switch (tile) {
            case Terrain.EMPTY_DECO -> "There are old blood stains on the floor.";
            case Terrain.BOOKSHELF -> "This is probably a vestige of a prison library. Might it burn?";
