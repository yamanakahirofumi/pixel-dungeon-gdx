...
public class Terrain {
    ...
    public static int discover(int terr) {
        return switch (terr) {
            ...
            case SECRET_FIRE_TRAP -> FIRE_TRAP;
            case SECRET_PARALYTIC_TRAP -> PARALYTIC_TRAP;
            case SECRET_TOXIC_TRAP -> TOXIC_TRAP;
            case SECRET_POISON_TRAP -> POISON_TRAP;
            case SECRET_ALARM_TRAP -> ALARM_TRAP;
            case SECRET_LIGHTNING_TRAP -> LIGHTNING_TRAP;
            case SECRET_GRIPPING_TRAP -> GRIPPING_TRAP;
            case SECRET_SUMMONING_TRAP -> SUMMONING_TRAP;
            default -> terr;
        };
    }
}
