...
public class CavesLevel extends RegularLevel {
    ...
    public String tileName(int tile) {
        return switch (tile) {
            case Terrain.GRASS -> "Fluorescent moss";
            case Terrain.HIGH_GRASS -> "Fluorescent mushrooms";
            case Terrain.WATER -> "Freezing cold water.";
    ...
    public String tileDesc(int tile) {
        return switch (tile) {
            case Terrain.ENTRANCE -> "The ladder leads up to the upper depth.";
            case Terrain.EXIT -> "The ladder leads down to the lower depth.";
            case Terrain.HIGH_GRASS -> "Huge mushrooms block the view.";
            case Terrain.WALL_DECO -> "A vein of some ore is visible on the wall. Gold?";
            case Terrain.BOOKSHELF -> "Who would need a bookshelf in a cave?";
