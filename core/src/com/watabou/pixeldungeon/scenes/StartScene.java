...
public class StartScene extends PixelScene {
    ...
    private static final HashMap<HeroClass, GemButton> gems = new HashMap<>();
    ...
    public void create() {
        ...
        btnMastery = new SimpleButton(Icons.MASTERY.get()) {
            @Override
            protected void onClick() {
                String text = switch (curClass) {
                    case WARRIOR -> HeroSubClass.GLADIATOR.desc() + "\n\n" + HeroSubClass.BERSERKER.desc();
                    case MAGE -> HeroSubClass.BATTLEMAGE.desc() + "\n\n" + HeroSubClass.WARLOCK.desc();
                    case ROGUE -> HeroSubClass.FREERUNNER.desc() + "\n\n" + HeroSubClass.ASSASSIN.desc();
                    case HUNTRESS -> HeroSubClass.SNIPER.desc() + "\n\n" + HeroSubClass.WARDEN.desc();
                };
    ...
    private void updateClass(HeroClass cl) {
        ...
        if (cl != HeroClass.HUNTRESS || huntressUnlocked) {
            ...
            Badges.Badge badgeToCheck = switch (curClass) {
