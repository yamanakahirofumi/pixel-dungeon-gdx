...
public class Heap implements Bundlable {
    ...
    public int image() {
        return switch (type) {
            case HEAP, FOR_SALE -> size() > 0 ? items.peek().image() : 0;
            case CHEST -> ItemSpriteSheet.CHEST;
            case LOCKED_CHEST -> ItemSpriteSheet.LOCKED_CHEST;
            case CRYSTAL_CHEST -> ItemSpriteSheet.CRYSTAL_CHEST;
            case TOMB -> ItemSpriteSheet.TOMB;
            case SKELETON -> ItemSpriteSheet.BONES;
        };
    }
