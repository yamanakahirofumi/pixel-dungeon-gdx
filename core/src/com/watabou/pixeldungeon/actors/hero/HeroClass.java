...
public enum HeroClass {
    ...
    public String spritesheet() {
        ...
        return switch (this) {
            case WARRIOR -> Assets.WARRIOR;
            case MAGE -> Assets.MAGE;
            case ROGUE -> Assets.ROGUE;
            case HUNTRESS -> Assets.HUNTRESS;
        };
    ...
    public String[] perks() {
        ...
        return switch (this) {
            case WARRIOR -> WAR_PERKS;
            case MAGE -> MAG_PERKS;
            case ROGUE -> ROG_PERKS;
            case HUNTRESS -> HUN_PERKS;
        };
