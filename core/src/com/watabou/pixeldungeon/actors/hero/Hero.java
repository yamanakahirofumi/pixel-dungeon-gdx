...
public class Hero extends Char {
    ...
    public int defenseSkill(Char enemy) {
        ...
        int bonus = 0;
        for (RingOfEvasion.Evasion buff : buffs(RingOfEvasion.Evasion.class)) {
            bonus += buff.level;
        }
        ...
        if (pos == stairs && pos == Dungeon.getInstance().level.entrance) {
            ...
            if (Dungeon.getInstance().depth == 1) {
                ...
                if (belongings.getItem(Amulet.class) == null) {
                    ...
                    Dungeon.getInstance().deleteGame(Dungeon.getInstance().hero.heroClass, true);
        ...
        if (belongings.weapon != null) {
            ...
            switch (subClass) {
                case GLADIATOR:
                    ...
                    break;
                case BATTLEMAGE:
                    if (weapon instanceof Wand wand) {
    ...
    public int stealth() {
        ...
        for (RingOfShadows.Shadows buff : buffs(RingOfShadows.Shadows.class)) {
            stealth += buff.level;
        }
        return stealth;
    }
    ...
    public void die(Object cause) {
        ...
        if (ankh == null) {
            ...
            Dungeon.getInstance().deleteGame(Dungeon.getInstance().hero.heroClass, false);
    ...
    public void move(int step) {
        ...
        if (!flying) {
            ...
            Dungeon.getInstance().level.press(step, this);
        }
    }
    ...
    public void onOperateComplete() {
        ...
        if (curAction instanceof HeroAction.Unlock) {
            ...
            Heap heap = Dungeon.getInstance().level.heaps.get(curAction.dst);
    ...
    public boolean search(boolean intentional) {
        ...
        int positive = 0;
        int negative = 0;
        for (RingOfDetection.Detection buff : buffs(RingOfDetection.Detection.class)) {
